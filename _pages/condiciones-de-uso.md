---
layout: page
title: Condiciones generales de acceso y uso del sitio web nota.yeste.studio
permalink: condiciones-de-uso
noindex: true
sitemap: false
---
El sitio web [nota.yeste.studio](https://nota.yeste.studio) es propiedad de Javier Sánchez Yeste
(en adelante el titular del sitio web) con dirección de correo electrónico
javier@yeste.studio, y a través del mismo proporciona información sobre el proyecto Nota y sus actividades.
...
Las presentes condiciones generales rigen única y exclusivamente el uso del sitio web [nota.yeste.studio](https://nota.yeste.studio)
por parte de los usuarios que accedan y/o naveguen por [nota.yeste.studio](https://nota.yeste.studio). Las presentes condiciones generales se exponen
en todas y cada una de las páginas del sitio web [nota.yeste.studio](https://nota.yeste.studio), para que los
usuarios puedan leerlas, imprimirlas y archivarlas.

## Condiciones de acceso y uso

La utilización del sitio web [nota.yeste.studio](https://nota.yeste.studio) es gratuita y no requiere el previo registro
...
[nota.yeste.studio](https://nota.yeste.studio) prohíbe expresamente:
...
[nota.yeste.studio](https://nota.yeste.studio) podrá interrumpir en cualquier momento el acceso a su sitio web si detecta un uso contrario a
...
Los contenidos incorporados en este sitio web han sido elaborados e incluidos por [nota.yeste.studio](https://nota.yeste.studio), utilizando
...
de terceros que figuren en [nota.yeste.studio](https://nota.yeste.studio).
...
Los contenidos propios, textuales y visuales, así como la programación y el diseño del sitio web [nota.yeste.studio](https://nota.yeste.studio) se encuentran plenamente
